...
type SchemaConfig struct {
	Card          string // Card table.
	Comment       string // Comment table.
	FieldType     string // FieldType table.
	File          string // File table.
	FileType      string // FileType table.
	Goods         string // Goods table.
	Group         string // Group table.
	GroupInfo     string // GroupInfo table.
	Item          string // Item table.
	Node          string // Node table.
	Pet           string // Pet table.
	Spec          string // Spec table.
	SpecCard      string // Spec-card->Card table.
